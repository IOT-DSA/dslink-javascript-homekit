declare namespace __dslink {
	...
	class Node {
		...
		get(name: string): any;
		forEachChild(callback: any): any;
		forEachConfig(callback: any): any;
		forEachAttribute(callback: any): any;
		getSimpleMap(): any;
	}
	...
	class ReqSubscribeController {
		...
		listen(callback: any, qos: number): any;
		unlisten(callback: any): any;
		updateQos(): boolean;
	...
	class ReqSubscribeListener {
		...
		onData(handleData: any): any;
		onDone(handleDone: any): any;
		onError(handleError: any): any;
	...
	class ListDefListener {
		...
		constructor(node: RemoteNode, requester: Requester, callback: any);
	...
	class Scheduler {
		...
		static every(interval: any, action: any): any;
		static safeEvery(interval: any, action: any): any;
		static repeat(times: number, action: any): Promise<any>;
		static tick(times: number, interval: Interval, action: any): Promise<any>;
		static runLater(action: any): any;
		static later(action: any): Promise<any>;
		static after(duration: any, action: any): Promise<any>;
		static runAfter(duration: any, action: any): any;
		constructor();
	}
	...
	class DefinitionNode extends LocalNodeImpl {
		...
		onStartListListen(): any;
		onAllListCancel(): any;
		subscribe(callback: any, qos?: number): RespSubscribeListener;
		unsubscribe(ValueUpdateCallback: any): any;
